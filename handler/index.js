...
const loadEvents = async function (client) {
    ...
    for (const folder of eventFolders) {
        ...
        for (const file of eventFiles) {
            ...
            if (event.name) {
                console.log(chalk.bgBlueBright.black(` ✅  | Evento ${file} carregado.`));
            } else {
    ...
    for (const folder of commandFolders) {
        ...
        for (const file of commandFiles) {
            ...
            if (command.name) {
                ...
                console.log(chalk.bgBlueBright.black(` ✅  | Comando de prefixo ${file} carregado.`));
            } else {
    ...
    for (const folder of commandFolders) {
        ...
        for (const file of commandFiles) {
            ...
            if (command.name) {
                ...
                slash.push(command)
                console.log(chalk.bgBlueBright.black(` ✅  | slashcommand ${file} carregado.`));
            } else {
